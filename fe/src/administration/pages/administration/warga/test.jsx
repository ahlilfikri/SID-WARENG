        ...
        <div className="container-fluid" style={{ display: 'flex', height: '100vh', width: '100vw', overflow: 'hidden' }}>
            ...
            <div className="warping-sidebar" style={{ position: 'fixed', left: -10, top: 110, height: '70vh' }}>
                <Sidebar 
                    ...
                    setSelectedContent={setSelectedContent} // Pass setSelectedContent to Sidebar
                />
            </div>
            <div className="content" style={{ marginTop: '10%', marginRight: '11%', marginLeft: isShrinkView ? '92px' : '240px', width: `calc(100% - ${isShrinkView ? '92px' : '240px'})`, height: '100vh', overflow: 'hidden' }}>
                <div className="warping-container" style={{ overflowY: 'auto', height: '100%' }}>
                    {renderContent()}
                </div>
