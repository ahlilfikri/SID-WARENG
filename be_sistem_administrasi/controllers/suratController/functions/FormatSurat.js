...
//             return await formatSurat_izinUsaha.format_suratIzinUsaha(subSuratId);
//         }
//         if (jenisSurat === 'bantuan sosial') {
//             return await formatSurat_bantuanSosial.format_bantuanSosial(subSuratId);
//         }
//         if (jenisSurat === 'keterangan nikah') {
//             return await formatSurat_keteranganNikah.format_suratKeteranganNikah(subSuratId);   
//         }
//         return '';
//     } catch (err) {
//         console.error(err);
...
//             <div class="isi-surat">
//             ${
//                 await suratDecider(jenisSurat,subSuratId)
//             }
//             </div>
